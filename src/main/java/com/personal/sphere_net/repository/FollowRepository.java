...
public interface FollowRepository extends JpaRepository<Follow, Long> {
    ...
    @Query(value = "SELECT f.follower FROM Follow f WHERE f.followed.user_id=:userId")
    List<User> findFollowers(Long userId);

    @Query(value = "SELECT f.followed FROM Follow f WHERE f.follower.user_id=:userId")
